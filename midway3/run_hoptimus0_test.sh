#!/bin/bash
#SBATCH --job-name=hoptimus0_test
...
#SBATCH --output=/scratch/beagle3/<user>/<workdir>/logs/hoptimus0_test_%j.out
#SBATCH --error=/scratch/beagle3/<user>/<workdir>/logs/hoptimus0_test_%j.err
