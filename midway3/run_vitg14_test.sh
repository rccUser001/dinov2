#!/bin/bash
#SBATCH --job-name=dinov2_vitg_test
...
#SBATCH --output=/scratch/beagle3/<user>/<workdir>/logs/vitg_test_%j.out
#SBATCH --error=/scratch/beagle3/<user>/<workdir>/logs/vitg_test_%j.err
