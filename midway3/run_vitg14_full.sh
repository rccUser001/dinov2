#!/bin/bash
#SBATCH --job-name=dinov2_vitg_full
...
#SBATCH --output=/scratch/beagle3/<user>/<workdir>/logs/vitg_full_%j.out
#SBATCH --error=/scratch/beagle3/<user>/<workdir>/logs/vitg_full_%j.err
